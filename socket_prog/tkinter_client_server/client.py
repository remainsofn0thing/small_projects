...
class GUI:
    ...
    def __init__(self):
        ...
        self.Window = Tk()  # создаем граф. окно
        self.Window.withdraw()  # cкрываем окно

        # login window
        self.login = Toplevel()  # созданиe окна поверх всех остальных окон.
        # set the title
        ...
        self.login.configure(width=400,
                             height=300)
        # create a Label
        self.pls = Label(self.login,  # ссылка на родительский контейнер
        ...
        self.go = Button(self.login,
                         ...
                         command=lambda: self.goAhead(
                             self.entryName.get()))  # вызвал удаление логина и переход в чат при нажатии на кнопку
